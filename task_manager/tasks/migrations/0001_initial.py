# Generated by Django 4.2.2 on 2023-09-05 20:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='author', to='users.myuser', verbose_name='Author')),
                ('executor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='executor', to='users.myuser', verbose_name='Executor')),
            ],
            options={
                'verbose_name': 'Task',
